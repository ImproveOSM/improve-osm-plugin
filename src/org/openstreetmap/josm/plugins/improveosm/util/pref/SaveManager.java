...
final class SaveManager {
    ...
    void saveOnewayFilter(final OnewayFilter filter) {
        if (filter != null) {
            ...
            if (filter.getConfidenceLevels() != null) {
                StructUtils.putListOfStructs(Config.getPref(), DOF_CONFIDENCE_LEVEL, filter.getConfidenceLevels(),
                        OnewayConfidenceLevel.class);
            }
        }
    }
    ...
    void saveMissingGeoFilter(final MissingGeometryFilter filter) {
        if (filter != null) {
            ...
            if (filter.getTypes() != null) {
                StructUtils.putListOfStructs(Config.getPref(), MG_TYPE, filter.getTypes(), TileType.class);
            }
    ...
    void saveTurnRestrictionFilter(final TurnRestrictionFilter filter) {
        if (filter != null) {
            ...
            // confidence levels
            if (filter.getConfidenceLevels() != null) {
                StructUtils.putListOfStructs(Config.getPref(), TR_CONFIDENCE_LEVEL, filter.getConfidenceLevels(),
                        TurnConfidenceLevel.class);
            }
        }
    }
